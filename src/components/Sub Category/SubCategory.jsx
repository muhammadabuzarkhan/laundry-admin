...
//     console.log('Form submitted:', formData);
//     setIsModalOpen(false);
//     setFormData({ title: '', category: '', description: '', price: '', image: null });
//   };
...
//                 <td>
//                   <div className={styles.categoryIcon} style={{ backgroundColor: subcategory.imageColor }}>
//                     <img src={`${process.env.REACT_APP_API_BASE_URL}/${subcategory.imageUrl}`} alt="Category" width="24" height="24" />
//                   </div>
//                 </td>
//                 <td>{subcategory.date}</td>
//                 <td className={styles.actionButtons}>
...
//                 <button type="submit" className={styles.submitButton}>Save Sub Category</button>
//               </div>
//             </form>
//           </div>
//         </div>
...
const SubCategory = () => {
  ...
  const handleSubmit = (formData) => {
    console.log('Form submitted:', formData);
    setIsModalOpen(false);
    // Here you can also handle the POST request
  };
